...
class Config:
    ...
    def load_config_json(self) -> dict:
        ...
        for config_file in version_config_paths:
            ...
            # Construct the correct config path
            config_path = os.path.join(project_root, "rvc", "configs", config_file)
    ...
    def set_precision(self, precision):
        ...
        for config_path in version_config_paths:
            full_config_path = os.path.join("services", "rvc", "configs", config_path)
            try:
